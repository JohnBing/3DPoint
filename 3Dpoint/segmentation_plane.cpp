...
//		std::stringstream ss;
//		ss << "data/table_scene_lms400_plane_" << i << ".pcd"; //对每一次的提取都进行了文件保存
...
//
//	pcl::io::loadPCDFile("data/table_scene_lms400_plane_0.pcd", *cloud_seg1);
//	pcl::io::loadPCDFile("data/table_scene_lms400_plane_1.pcd", *cloud_seg2);
//	pcl::io::loadPCDFile("data/table_scene_lms400_downsampled.pcd", *cloud_voxel);
//	/*
//	//将提取结果进行统计学滤波
